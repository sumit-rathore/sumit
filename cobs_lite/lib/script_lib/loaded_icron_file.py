...
class Loaded_icron_file:
    ...
    def get_icmd_resp(self, ser):
        ...
        if num_args == 1:
            args = [icmdResp[16] | icmdResp[15] << 8 | icmdResp[14] << 16 | icmdResp[13] << 24]
        elif num_args == 2:
            args = [icmdResp[16] | icmdResp[15] << 8 | icmdResp[14] << 16 | icmdResp[13] << 24, 
                    icmdResp[20] | icmdResp[19] << 8 | icmdResp[18] << 16 | icmdResp[17] << 24]
        elif num_args == 3:
            args = [icmdResp[16] | icmdResp[15] << 8 | icmdResp[14] << 16 | icmdResp[13] << 24, 
                    icmdResp[20] | icmdResp[19] << 8 | icmdResp[18] << 16 | icmdResp[17] << 24,
                    icmdResp[24] | icmdResp[23] << 8 | icmdResp[22] << 16 | icmdResp[21] << 24]

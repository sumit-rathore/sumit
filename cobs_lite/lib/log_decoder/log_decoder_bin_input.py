...
import datetime
import traceback
import decoder_lib.icron_depacketizer as idp
import decoder_lib.icron_file_parser as ifp
import decoder_lib.icron_model as im
import decoder_lib.icron_ilog as ilg
import decoder_lib.icron_device_info as idi
import decoder_lib.icron_istatus as iis
...
if __name__ == '__main__':
    if len(sys.argv) == 3:
        try:
            ...
            with io.open("output.txt", 'a', encoding='utf-8') as out_file:
        ...
        print("USAGE: icron_log_decoder.py [log.gz] [icron_file]\n")

...
class ILog():
    ...
    @property
    def event_debug_pink(self):
        return self.severity_level_index == 6

    @property
    def event_debug_green(self):
        return self.severity_level_index == 7

    @property
    def event_debug_orange(self):
        return self.severity_level_index == 8

    @property
    def user_log(self):
        return self.severity_level_index == 9

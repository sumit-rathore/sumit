...
(
    uint8 byte,                     // the byte to process
    uint32 * buf,                   // the buffer
...
)
{
    ...
    {
        // data or checksum
        uint8 curOffset = pCurState->curOffsetIncHeader - XMODEM_HEADER_SIZE;

...
//!   @file  -  linkmgr_cmd.h
//
//!   @brief -  This file contains the icmd information for the link manager component
//
//
//!   @note  -
//
///////////////////////////////////////////////////////////////////////////////
#ifndef LINKMGR_CMD_H
#define LINKMGR_CMD_H
...
ICMD_FUNCTIONS_CREATE(LINKMGR_COMPONENT)
    ICMD_FUNCTIONS_ENTRY(icmdGetPhyStatus, "Read and decode the PHY control and status registers", void)
    ICMD_FUNCTIONS_ENTRY(showLinkState, "Show the states of the link managers", void)

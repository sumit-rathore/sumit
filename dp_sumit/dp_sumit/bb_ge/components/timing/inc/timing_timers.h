...
TIMING_TimerHandlerT TIMING_TimerRegisterHandler(
    void (*timeoutCallback)(void), boolT periodic, uint32 timeoutInMs);
...
void TIMING_TimerResetTimeout(TIMING_TimerHandlerT handler, uint32 timeoutInMs) __attribute__((section(".ftext")));
boolT TIMING_TimerEnabled(TIMING_TimerHandlerT handler) __attribute__((section(".ftext")));
uint32 TIMING_TimerGetTimeout(TIMING_TimerHandlerT handler) __attribute__((section(".ftext")));

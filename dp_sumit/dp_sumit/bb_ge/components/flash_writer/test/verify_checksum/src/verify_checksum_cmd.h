...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef VERIFY_CHECKSUM_CMD_H
#define VERIFY_CHECKSUM_CMD_H
...
ICMD_FUNCTIONS_CREATE(TEST_HARNESS_COMPONENT)
    ICMD_FUNCTIONS_ENTRY(TestCheckSum, "Read the checksum of bytes. Argument: number of bytes to read", uint32)
ICMD_FUNCTIONS_END(TEST_HARNESS_COMPONENT)

#endif // VERIFY_CHECKSUM_CMD_H

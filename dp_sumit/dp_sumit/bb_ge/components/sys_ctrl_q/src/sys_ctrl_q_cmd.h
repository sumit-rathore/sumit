...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef SYS_CTRL_Q_CMD_H
#define SYS_CTRL_Q_CMD_H
...
ICMD_FUNCTIONS_CREATE(SYS_CTRL_Q_COMPONENT)
    ICMD_FUNCTIONS_ENTRY(showExpectedPacket, "Show the expected packet for a particular USB address that has BCO/BCI set", uint8)
ICMD_FUNCTIONS_END(SYS_CTRL_Q_COMPONENT)

#endif // SYS_CTRL_Q_CMD_H

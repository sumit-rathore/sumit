...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef PLL_TEST_CMD_H
#define PLL_TEST_CMD_H
...
ICMD_FUNCTIONS_CREATE(TEST_HARNESS_COMPONENT)
    ICMD_FUNCTIONS_ENTRY(TEST_status, "Generic test harness status command; customize to your needs", void)
ICMD_FUNCTIONS_END(TEST_HARNESS_COMPONENT)

#endif // PLL_TEST_CMD_H

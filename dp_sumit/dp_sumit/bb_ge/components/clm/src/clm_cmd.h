...
ICMD_FUNCTIONS_CREATE(CLM_COMPONENT)
    ICMD_FUNCTIONS_ENTRY(CLM_LogRxStats, "Log the RX Stats register", void)
    ICMD_FUNCTIONS_ENTRY(CLM_LogTxStats, "Log the TX Stats register", void)
    ICMD_FUNCTIONS_ENTRY(CLM_AdjustTxWaitForRespLimit, "Adjust TX wait for response limit, args: limit, CntThresh", uint8, uint8)
    ICMD_FUNCTIONS_ENTRY(CLM_AdjustTxQidThresh, "Adjust TX QID Threshold. IE # of packets in flight (1-15)", uint8)
ICMD_FUNCTIONS_END(CLM_COMPONENT)

...
/***************************** Local Variables *******************************/
IPOOL_CREATE(test, uint64_t, SIZE_OF_POOL)
...
{
    uint64_t* e[SIZE_OF_POOL];
    for (uint8_t i = 0; i < SIZE_OF_POOL; i++)
    {
        e[i] = test_poolAlloc();

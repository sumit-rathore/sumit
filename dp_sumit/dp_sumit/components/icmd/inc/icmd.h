...
#define ICMD_FUNCTIONS_ENTRY(_function_, _help_string_, _args_...) void _function_(_args_) __attribute__((section(".atext")));
#define ICMD_FUNCTIONS_ENTRY_FLASH(_function_, _help_string_, _args_...) void _function_(_args_) __attribute__((section(".flashcode")));
...
// note the return value here is only valid until the called iCmd function returns!
uint8_t ICMD_GetResponseID(void);

#endif // ICMD_H
/************************** Custom Parser Include ****************************/
#else // } else { // ICMD_PARSER
...
#endif
#ifdef ICMD_FUNCTIONS_ENTRY_FLASH
#undef ICMD_FUNCTIONS_ENTRY_FLASH
#endif
...
#define ICMD_FUNCTIONS_ENTRY_FLASH(_function_, _help_string_, _args_...)  ICMD_PARSER(_function_, _help_string_, _args_)

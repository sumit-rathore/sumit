...
#define LEON_R_REG_ACCESS_ERR       ((trapT)0x20)
#define LEON_INST_ACCESS_ERR        ((trapT)0x21)
#define LEON_UNDEFINED_22_TRAP      ((trapT)0x22)
#define LEON_UNDEFINED_23_TRAP      ((trapT)0x23)
#define LEON_CP_DISABLED_TRAP       ((trapT)0x24)
#define LEON_UNIMPLEMENTED_FLUSH    ((trapT)0x25)
#define LEON_UNDEFINED_26_TRAP      ((trapT)0x26)
#define LEON_UNDEFINED_27_TRAP      ((trapT)0x27)
#define LEON_CP_EXCEPTION_TRAP      ((trapT)0x28)
#define LEON_DATA_ACCESS_ERR        ((trapT)0x29)
#define LEON_DIVIDE_BY_ZERO_TRAP    ((trapT)0x2a)
#define LEON_DATA_STORE_ERR         ((trapT)0x2b)
#endif
...
void LEON_EnableIrq2Bits(uint32_t);
void LEON_DisableIrq2Bits(uint32_t);
...
uint32_t LEON_GetPendingIrq(void);  // get any pending, enabled IRQ's
...
static inline void LEON_InstallIrqHandler(irqT i, void (*fcn)(void))
    { LEON_InstallTrapHandler((trapT)((uint32_t)i + _LEON_IRQ_TO_TRAP_OFFSET), fcn); }
...
static inline irqFlagsT LEON_LockIrq(void) { return _LEON_IrqPriorityModify((irqFlagsT)LEON_PSR_PIL_MASK); }
#else

...
#ifndef TIMER_APERIODIC_TEST_LOG_H
#define TIMER_APERIODIC_TEST_LOG_H
...
ILOG_CREATE(TEST_HARNESS_COMPONENT)
    ILOG_ENTRY(STARTUP, "Test harness has started, about to start timer, only expect isr to be called once.\n")
    ILOG_ENTRY(ITERATION, "ISR has been called: %d times\n")
    ILOG_ENTRY(FINISHED, "Test harness has finished\n")
ILOG_END(TEST_HARNESS_COMPONENT, ILOG_DEBUG)

#endif // #ifndef TIMER_APERIODIC_TEST_LOG_H

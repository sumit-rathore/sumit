...
//     ICMD_FUNCTIONS_ENTRY_FLASH(RANDOM_AddEntropy, "Add Entropy to random number generator", uint8)
//     ICMD_FUNCTIONS_ENTRY_FLASH(getQuickPseudoRandom, "Get a quick pseudo random number", void)
//     ICMD_FUNCTIONS_ENTRY_FLASH(RANDOM_QuickPseudoRandomNewSeed, "Write a new seed into the quick pseudo random # generator", uint32)

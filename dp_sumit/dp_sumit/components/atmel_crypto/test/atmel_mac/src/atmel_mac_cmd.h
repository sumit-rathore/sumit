...
ICMD_FUNCTIONS_CREATE(TEST_HARNESS_COMPONENT)
    ICMD_FUNCTIONS_ENTRY_FLASH(writeChallengeBuf, "Write to challenge buffer. Args: index, byte", uint8, uint8)
    ICMD_FUNCTIONS_ENTRY_FLASH(showChallengeBuf, "Show the challenge buffer", void)
    ICMD_FUNCTIONS_ENTRY_FLASH(runMacTest, "Run the MAC test", void)

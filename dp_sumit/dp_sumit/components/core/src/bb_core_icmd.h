...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef BB_CORE_CMD_H
#define BB_CORE_CMD_H
...
ICMD_FUNCTIONS_CREATE(CORE_COMPONENT)
    ICMD_FUNCTIONS_ENTRY_FLASH(BBCORE_printHWModuleVersion, "Show FPAGE modules' version", void)
ICMD_FUNCTIONS_END(CORE_COMPONENT)

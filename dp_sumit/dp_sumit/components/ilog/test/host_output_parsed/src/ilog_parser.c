...
static void parseLog(bool previousLogPrinted, uint8_t componentNumber, uint8_t msgNumber, uint8_t severityLevel, uint8_t numOfArgs, uint32_t arg1, uint32_t arg2, uint32_t arg3);
static void sendByteToParser(uint8_t rxByte);
...
(
 bool previousLogPrinted,
 uint8_t componentNumber,
 uint8_t msgNumber,
 uint8_t severityLevel,
 uint8_t numOfArgs,
 uint32_t arg1,
 uint32_t arg2,
 uint32_t arg3
...
)
{
    ...
    static bool previousLogPrinted;
    static uint8_t numOfArgs;
    static uint8_t componentNumber;
    static uint8_t msgNumber;
    static uint8_t severityLevel;
    static uint32_t args[3];
    static uint8_t currByte = 0;
    uint8_t nextByte = currByte + 1;
...
*
*/
bool ilog_TestHarnessAtomicPrint
(
    uint8_t *msg, //
    uint8_t bytes //
)

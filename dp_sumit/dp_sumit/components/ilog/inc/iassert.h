...
/***************************** Included Headers ******************************/
// Runtime asserts functions are including in the ilog.h file as they are heavily dependent on the logging
#include <ilog.h>

/******************************** Data Types *********************************/
typedef void (*assertHookEndFunctionT)(void)    __attribute__ ((noreturn));

...
//    Blackbird Badger ICMD
    ICMD_FUNCTIONS_ENTRY_FLASH(Badger_getDeviceInfo, "Print out the device info for Badger", void)
#ifdef PLATFORM_K7
...
#endif
#ifdef DEBUG
    ICMD_FUNCTIONS_ENTRY(TOPLEVEL_DEBUG_ASSERT, "Test Assert", void)
#endif
